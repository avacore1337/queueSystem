...
queueControllers.controller('aboutController', ['$scope', 'TitleService',
  function ($scope, title) {
    ...
    $scope.contributors = {
      StayAWhile:[{name:"Anton Bäckström", gravatar:"7eaf43cc9a0edf01b4994318e03fe368", twitter:"", github:""},
      {name:"Per Nyberg", gravatar:"", twitter:"", github:""},
      {name:"Robert Welin-Berger", gravatar:"", twitter:"", github:""},
      {name:"Edvard Mickos", gravatar:"", twitter:"", github:""},
      {name:"Pontus Blomberg", gravatar:"", twitter:"", github:""},
      {name:"Erik Tobias Lansner", gravatar:"", twitter:"", github:""},
      {name:"Henrik Johansson", gravatar:"", twitter:"", github:""},
      {name:"Samuel Philipson", gravatar:"", twitter:"", github:""},
      {name:"Christoffer Neppare", gravatar:"", twitter:"", github:""},
      {name:"Thomas Jorsell", gravatar:"", twitter:"", github:""}], 
